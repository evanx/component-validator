...
<i>Out of scope: Note that the content of the config metadata, and its use for defaulting and validation, must be specified by the component supervisor implementation.</i>
