...
Nevertheless, a specific component supervisor implementation might be explicitly limited to such "implicit properties" components, which is fine. It should validate its components e.g. to detect the misconfiguration of components that are unsupported third-party plugins.
